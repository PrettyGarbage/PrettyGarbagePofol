...
namespace Mine.Code.Framework.Manager.UINavigator.Runtime
{
    ...
    public abstract class UIContainer<T> : UIContainer where T : UIContainer<T>
    {
        ...
        public static T Main
        {
            get
            {
                T main = global::Mine.Code.Framework.Manager.UINavigator.Runtime.UINavigator.In.GetMain<T>();
                if (main) return main;
                ...
                for (int i = 0; i < SceneManager.sceneCount; i++)
                {
                    ...
                    if (scene.isLoaded)
                    {
                        ...
                        global::Mine.Code.Framework.Manager.UINavigator.Runtime.UINavigator.In.SetMain(main);
                        if (main) return main;
                    }
                }
