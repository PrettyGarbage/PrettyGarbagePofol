...
namespace Mine.Code.Framework.Manager.RequestBuilder
{
    ...
    public class GetRequest : Request
    {
        ...
        public async UniTask<UnityWebRequest> SendAsync() => await SendWithHandlerAsync(new DownloadHandlerBuffer());
        public async UniTask<UnityWebRequest> SendWithHandlerAsync(DownloadHandler downloadHandler) => await SendAsync(new UnityWebRequest($"{baseUrl}/{path}", "GET") { downloadHandler = downloadHandler });
    }
    ...
    public class PostRequest : Request
    {
        ...
        public async UniTask<UnityWebRequest> SendAsync(string post) => await SendWithHandlerAsync(new UploadHandlerRaw(Encoding.UTF8.GetBytes(post)), new DownloadHandlerBuffer());
        public async UniTask<UnityWebRequest> SendWithHandlerAsync(UploadHandler uploadHandler, DownloadHandler downloadHandler) => await SendAsync(new UnityWebRequest($"{baseUrl}/{path}", "POST") { uploadHandler = uploadHandler, downloadHandler = downloadHandler });
    }
    ...
    public class PutRequest : Request
    {
        ...
        public async UniTask<UnityWebRequest> SendAsync(string body) => await SendWithHandlerAsync(new UploadHandlerRaw(Encoding.UTF8.GetBytes(body)), new DownloadHandlerBuffer());
        public async UniTask<UnityWebRequest> SendWithHandlerAsync(UploadHandler uploadHandler, DownloadHandler downloadHandler) => await SendAsync(new UnityWebRequest($"{baseUrl}/{path}", "PUT") { uploadHandler = uploadHandler, downloadHandler = downloadHandler });
    }
    ...
    public class DeleteRequest : Request
    {
        ...
        public async UniTask<UnityWebRequest> SendAsync() => await SendWithHandlerAsync(new DownloadHandlerBuffer());
        public async UniTask<UnityWebRequest> SendWithHandlerAsync(DownloadHandler downloadHandler) => await SendAsync(new UnityWebRequest($"{baseUrl}/{path}", "DELETE") { downloadHandler = downloadHandler });
    }
}
#endif