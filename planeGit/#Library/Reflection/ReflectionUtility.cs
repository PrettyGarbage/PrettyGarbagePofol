...
namespace Library.Util.Reflection
{
    public static class ReflectionUtility
    {
        ...
        //지정 Type 내의 특정 Attribute가 붙은 메소드들을 찾아서 반환한다.
        public static ReadOnlyCollection<MethodInfo> GetMethodsByAttribute<TTarget, TAttribute>()
        {
            return GetMethodsByAttribute(typeof(TTarget), typeof(TAttribute));
        }
        
        //지정 Type 내의 특정 Attribute가 붙은 메소드들을 찾아서 반환한다.
        public static ReadOnlyCollection<MethodInfo> GetMethodsByAttribute(Type targetType, Type attributeType)
        {
            return MethodByAttributeCache.GetMethodsByAttribute(targetType, attributeType);
        }
        ...
        //지정된 타입의 메소드 멤버 목록을 가져온다.
        public static ReadOnlyCollection<MethodInfo> GetMethods(Type type)
        {
            return MethodCache.GetMethodInfos(type);
        }
    }
}