...
public class DE_004_B : Mission
{
    #region Fields

    [SerializeField] GameObject BeltIcon;
    // 착용 애니 및 active 등 복합적으로 쓰일 가능성이 있어 timeline으로 받아서 사용
    [SerializeField] PlayableDirector director_004_B;
    ...
    public override void SetMission()
    {
        ...
        OnBeginMission(2, true).Subscribe(async _ =>
        {
            ...
            await director_004_B.PlayAsync();
