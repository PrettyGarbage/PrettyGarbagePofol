...
public class EW_024_B : Mission
{
    #region Fields

    [SerializeField] PlayableDirector director_EW_024_B_1;
    ...
    public override void SetMission()
    {
        ...
        {            
            ...
            Logger.Log("Jumpseat에서 일어나 Jumpseat 아래 Flashlight를 선택하는 연출하기.");
            
            await director_EW_024_B_1.PlayAsync();
