...
public class EW_005_D : Mission
{
    #region Fields

    [SerializeField] PlayableDirector director_EW_005_D_2;
    ...
    public override void SetMission()
    {
        ...
        {
            /*npc8.Animator.SetTrigger(Constants.EquipBelt);
            npc8.Seat.Belt.Animator.SetBool(Constants.IsEquipBelt, true);

            await npc8.Animator.WaitAnimationCompleteAsync();*/
            
            await director_EW_005_D_2.PlayAsync();
