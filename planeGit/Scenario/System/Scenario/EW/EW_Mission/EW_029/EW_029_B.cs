...
public class EW_029_B : Mission
{
    #region Feilds

    [SerializeField] PlayableDirector director_29_B_1;
    ...
    public override void SetMission()
    {
        ...
        {
            // 헤엄쳐서 raft위로 올라가기까지
            await director_29_B_1.PlayAsync();
            try
            {
                NPCListModel.Instance.Gets(1, 3, 6, 7, 8, 11).ForEach
                (
