...
public class EW_014_C : Mission
{
    #region Fields

    [SerializeField] PlayableDirector director_EW_014_C_2;
    ...
    public override void SetMission()
    {
        ...
        {
            Logger.Log("7번 승객이 가까운 비상구 지목하기 연출(R2)");
            
            await director_EW_014_C_2.PlayAsync();
