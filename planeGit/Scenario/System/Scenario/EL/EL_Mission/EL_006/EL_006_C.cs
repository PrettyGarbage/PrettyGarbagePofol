...
public class EL_006_C : Mission
{
    #region Fields

    [SerializeField] PlayableDirector director_EL_006_C_1;
    ...
    public override void SetMission()
    {
        ...
        OnBeginMission(3, true).Subscribe(async _ =>
        {
            ...
            NPCListModel.Instance.Get(9).Animator.SetFloat(Constants.IdleState, 0);
            
            NextMission();
        }).AddTo();

        OnBeginMission(4).Subscribe(_ => { LastMissionComplete(); }).AddTo();
    }
