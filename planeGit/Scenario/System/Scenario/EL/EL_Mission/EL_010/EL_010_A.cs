...
public class EL_010_A : Mission
{
    #region Fields

    [SerializeField] PlayableDirector director_EL_010_A_1;
    [SerializeField] PlayableDirector director_EL_010_A_2;
    [SerializeField] PlayableDirector director_EL_010_A_3;
    [SerializeField] PlayableDirector director_EL_010_A_4;
    [SerializeField] PlayableDirector director_EL_010_A_5;
    [SerializeField] PlayableDirector director_EL_010_A_6;
    ...
    public override void SetMission()
    {
        ...
        OnBeginMission(3, true).Subscribe(async _ =>
        {
            ...
            await director_EL_010_A_2.PlayAsync();
            NextMission();
        }).AddTo();
        ...
        OnBeginMission(5, true).Subscribe(async _ =>
        {
            ...
            await director_EL_010_A_3.PlayAsync();
            NextMission();
        }).AddTo();
        ...
        OnBeginMission(7, true).Subscribe(async _ =>
        {
            ...
            await director_EL_010_A_4.PlayAsync();
            NextMission();
        }).AddTo();
        ...
        OnBeginMission(9, true).Subscribe(async _ =>
        {
            ...
            await director_EL_010_A_5.PlayAsync();
            NextMission();
        }).AddTo();
        ...
        {
            Logger.Log("Door를 열리는 애니");
            await director_EL_010_A_6.PlayAsync();
            NextMission();
        }).AddTo();
